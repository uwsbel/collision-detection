...
Broadphase::Broadphase(custom_vector<real3> aabb_data) {
	debugMode = false;
	number_of_contacts_possible = 0;
	val = 0;
	last_active_bin = 0;
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
int Broadphase::updateBoundingBoxes(custom_vector<real3> aabb_data) {
	this->aabb_data = aabb_data;
	numAABB = aabb_data.size()/2;
}
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
int Broadphase::activateDebugMode()
{
	debugMode = true;
	return 0;
}
int Broadphase::deactivateDebugMode()
{
	debugMode = false;
	return 0;
}
...
//--------------------------------------------------------------------------
void Broadphase::host_Count_AABB_BIN_Intersection(
        const real3* aabb_data,
        uint* Bins_Intersected) {
...
void Broadphase::host_Store_AABB_BIN_Intersection(
        const real3* aabb_data,
        const uint* Bins_Intersected,
        uint * bin_number,
        uint * body_number) {
...
//--------------------------------------------------------------------------
void Broadphase::host_Count_AABB_AABB_Intersection(
        const real3* aabb_data,
        const uint * bin_number,
        const uint * body_number,
        const uint * bin_start_index,
...
int Broadphase::detectPossibleCollisions() {
